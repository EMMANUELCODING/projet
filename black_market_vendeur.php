...
<body>
    ...
    <header>
        ...
        <div class="navbar">
            <a href="ajout.php">Vendre un article</a>
            <a href="mes_articles.php">Voir mes articles</a>
    ...
    <?php require_once 'bars_trait.php' ?>
            ...
            <div class="article">
                <div class="row">
                    ...
                    <div class="description">
                        <h2><?= $produi->nom ?> </h2>
                        <p><?= substr($produi->description, 0, 175) ?></p>
                    </div>
                    <div class="acheter">
